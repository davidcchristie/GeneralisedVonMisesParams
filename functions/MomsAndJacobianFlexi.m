...
% This function can also be used to find the location parameters mu1-theta0 and
% mu2-theta0 from the k1, k2, Psi values (if GetLoc is true).  In which case, it
% simply returns these two quantities (and normalisation).
    if nargin < 3  
        GetLoc = false;
    end
